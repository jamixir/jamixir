defmodule System.State do
  ...
  # Formula (4.4) v0.6.5 σ ≡ (α, β, γ, δ, η, ι, κ, λ, ρ, τ, φ, χ, ψ, π, ϑ, ξ)
  defstruct [
    # α
  ...
  def add_block(%State{} = state, %Block{header: h, extrinsic: e} = block) do
    ...
    with :ok <- Block.validate(block, state),
         ...
         # Formula (4.15) v0.6.5 - W*
         # Formula (4.16) v0.6.5 - (ϑ',ξ',δ‡,χ',ι',φ',C)≺ (W∗,ϑ,ξ,δ,χ,ι,φ,τ,τ′)
         %{
