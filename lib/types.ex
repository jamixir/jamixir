defmodule Types do
  ...
  # Formula (4.28) v0.6.4 - should be guarded as <= 2^32
  @type timeslot :: non_neg_integer()
  # Formula (4.21) v0.6.4 - NB - should be guarded as <= 2^64
  @type balance :: non_neg_integer()
  # Formula (4.23) v0.6.4 - NG - shoud be a 64-bit integer <= 2^64
