defmodule Constants do
  ...
  defmockable(:forget_delay, do: Jamixir.config()[:forget_delay])
  ...
  def max_age_lookup_anchor, do: Jamixir.config()[:max_age_lookup_anchor] || 14_400
  ...
  def max_service_id, do: 0xFFFF_FFFF
  ...
  # Formula (14.6) v0.7.2
  @doc "W_F = WG +32⌈log2(WM )⌉= 4488: The additional footprint in the Audits DA of a single imported segment."
  def audit_footprint, do: segment_size() + 32 * ceil(:math.log2(max_imports()))
