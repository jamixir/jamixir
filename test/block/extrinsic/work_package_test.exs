defmodule WorkPackageTest do
  ...
  describe "valid?/1" do
    ...
    test "validates different work_item imported_data_segments content size", %{wp: wp} do
      medium_work_item = build(:work_item, imported_data_segments: [{<<0::256>>, 10_000_000}])
      big_work_item = build(:work_item, imported_data_segments: [{<<0::256>>, 20_000_000}])
    ...
    test "validates different work_item imported_data_segments length", %{wp: wp} do
      ...
      in_limit_work_item = build(:work_item, imported_data_segments: rest)
      big_work_item = build(:work_item, imported_data_segments: [ds1 | rest])
      # WS*WC = 4104
