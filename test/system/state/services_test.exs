defmodule System.State.ServicesTest do
  ...
  describe "service_index_set/3" do
    test "returns correct set of service indices" do
      ...
      assurances = [
        %Assurance{
          ...
          assurance_values: <<0b111::3>>,
          validator_index: 0
        },
        %Assurance{
          # Assuring for first two cores
          assurance_values: <<0b110::3>>,
          validator_index: 1
        },
        %Assurance{
          # Assuring for first and third cores
          assurance_values: <<0b101::3>>,
          validator_index: 2
        }
      ]
      ...
      core_reports_intermediate_1 = [
        %CoreReport{
          work_report: %WorkReport{
            work_results: [%{service_index: 1}, %{service_index: 2}]
          }
        },
        %CoreReport{
          work_report: %WorkReport{
            work_results: [%{service_index: 3}]
          }
        },
        %CoreReport{
          work_report: %WorkReport{
            work_results: [%{service_index: 4}]
          }
        }
      ]
      ...
      result =
        Services.service_index_set(assurances, core_reports_intermediate_1, privileged_services)
  ...
  describe "gas_attributable_for_service/4" do
    test "test 1" do
      ...
      result_for_service_1 =
        Services.gas_attributable_for_service(
          1,
          assurances,
          core_reports_intermediate_1,
          services_intermediate
    ...
    test "test 2" do
      assurances = [
        %Assurance{assurance_values: <<0b111::3>>, validator_index: 0},
        %Assurance{assurance_values: <<0b110::3>>, validator_index: 1},
        %Assurance{assurance_values: <<0b011::3>>, validator_index: 2}
      ]
